...
// }, [])
  ...
  return (
    <div >
      <h1 className="text-5xl mt-24  flex justify-center">100 Dsa Questions</h1>
      <h3 className="text-4xl mt-3 text-blue-800 align-items-center text-center  flex justify-center">
...
{/*        
    ...
    ans = op!=null?op.length:0;
      ...
      <div className="mb-10">
        <div className="flex justify-center ">
          <p className="text-black-600 font-nunito "> Linkedin : &nbsp;</p>
          <Link
            target="_blank"
            className=" text-blue-600 font-nunito "
            to="https://www.linkedin.com/in/shreya-tiwari-1a1162257?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
          >
            {" "}
            Shreya Tiwari &nbsp;
          </Link>
        ...
        <div className="flex justify-center">
          ...
          <Link
            ...
            to="https://github.com/Shreya-230"
          >
            &nbsp; Github \ Shreya-230{" "}
          </Link>
        </div>
